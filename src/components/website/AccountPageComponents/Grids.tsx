import { BookUser, Medal, MessageCircleQuestion, PackageOpen, PencilLine, SquarePen, TicketCheck } from 'lucide-react';
...
const Grids = () => {
  const actions = [
    { title: 'Order', description: 'Check For Order Status', icon: <PackageOpen />, url: '/my/orders' },
    { title: 'Returns & Refunds', description: 'Manage Returns & Refunds', icon: <SquarePen />, url: '/my/Refunds' },
    { title: 'Vouchers', description: 'Manage Your Vouchers', icon: <TicketCheck />, url: '/my/vouchers' },
    { title: 'My Earnings', description: 'Manage All Your Earnings', icon: <Medal />, url: '/my/earnings' },
    { title: 'Change Password', description: 'Change Your Password', icon: <PencilLine />, url: '/my/Change_Password' },
    { title: 'My Details', description: 'Add your Details', icon: <BookUser />, url: '/my/details' },
  ];
...
<div className='bg-white cursor-pointer shadow-md p-8 md:hidden'>
      ...
      <div className='flex flex-row justify-between'>
        <div className='flex flex-col'>
          <span className={`text-base transition-all duration-75 ease-in  text-gray-700 ${ 'text-black'}   `} >Total Earning</span>
