     ...
     <div className="max-w-7xl mx-auto mt-5 bg-white p-8 rounded-lg shadow">
        <Accordion type="single" collapsible className="w-full">
          ...
          <AccordionItem value="item-2">
            <AccordionTrigger>Can I modify the shipping address of my order after it&aposs been placed?</AccordionTrigger>
            <AccordionContent>
          ...
          <AccordionItem value="item-3">
            ...
            <AccordionContent>
            If you&aposve selected Cash on Delivery, there&aposs no amount to be refunded because you haven&apost paid for your order. For payments made via Credit/Debit Card/Netbanking, you will receive your refund to the source account within 5-7 days from the time you cancel your order.
            </AccordionContent>
          </AccordionItem>
          <AccordionItem value="item-4">
            <AccordionTrigger>What is Clicky&aposs cancellation policy?</AccordionTrigger>
            <AccordionContent>
            Only orders that haven&apost left the fulfilment centre can be cancelled. If the order has already been shipped from our fulfilment centre, you can refuse to accept it and send it back with the courier. In case you have paid using Netbanking/Debit/Credit Card, we&aposll refund your order amount only after we&aposve received the cancelled order at our fulfilment centre.
            </AccordionContent>
          </AccordionItem>
